...
from userpic.svg import make_svg_cell, make_svg_data


def test_make_svg_cell() -> None:
    cell = make_svg_cell(1, 2, 5, 4, "red")
...
def test_make_svg_data() -> None:
    ...
    expected_svg = '''<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
<rect x="5" y="5" width="2" height="2" style="fill:blue" />
    ...
    assert svg.decode().strip() == expected_svg.strip()
